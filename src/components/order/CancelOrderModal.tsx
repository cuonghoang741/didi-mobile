...
const CancelOrderModal: React.FC<CancelOrderModalProps> = ({
    ...
    const handleSubmit = async () => {
        if (!reason.trim()) {
            Alert.alert(t('common.error'), t('order.cancel.reasonRequired') || 'Vui lòng nhập lý do huỷ đơn');
            return;
        }
                    ...
                    >
                        ...
                        <View style={styles.content}>
                            <Typography variant='text' size='md' style={{ marginBottom: 12 }}>
                                {t('order.cancel.reasonPrompt') || 'Vui lòng cho chúng tôi biết lý do bạn huỷ đơn hàng này:'}
                            </Typography>
