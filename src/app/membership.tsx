...
const MembershipScreen = () => {
  ...
  const renderBenefitItem = (icon: React.ReactNode, title: string, description: string) => (
            ...
            >
                ...
                <View style={styles.rankCardContent}>
                  ...
                  <View style={styles.rankInfo}>
                    ...
                    <Typography
                      ...
                      style={[
                        styles.totalLabel,
                        { color: selectedRankInfo.textColor, opacity: 0.7 },
                      ]}
                    >
                      ...
                      {!isMaxRank && isCurrentRank && (
                        <Typography
                          ...
                          style={[
                            ...
                            { color: selectedRankInfo.textColor, opacity: 0.6 },
                          ]}
                        >
                    ...
                    <>
                      <View style={styles.progressBarContainer}>
                        ...
                        >
                          ...
                          />
                          <View
                            style={[styles.progressThumb, { left: `${getProgress() * 100}%` }]}
                          />
                        </View>
                      </View>
                      <Typography
                      ...
                      >
                        {t('membership.accumulateMore')} {formatCurrency(getRemainingToNextRank())}{' '}
                        {t('membership.toReach')} {getNextRankName()}
                      </Typography>
                    </>
                  )}
              ...
              <View style={styles.rankTabs}>
                {ranks.map((rank) => (
                  <Pressable
                    key={rank.key}
                    style={[styles.rankTab, selectedRank === rank.key && styles.rankTabActive]}
