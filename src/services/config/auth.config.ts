...
export const SUPABASE_URL =
  process.env.EXPO_PUBLIC_SUPABASE_URL ?? 'https://brsigfliyzwlomomoxqu.supabase.co';
export const SUPABASE_KEY =
  process.env.EXPO_PUBLIC_SUPABASE_KEY ?? 'sb_publishable_yTnYgR3r8pmTlhOlt1zRHQ_IQO54sBe';
