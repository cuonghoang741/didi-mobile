export const vi = {
  ...
  product: {
    ...
    viewMore: 'Xem thêm',
    collapse: 'Thu gọn',
    sellerResponse: 'Phản hồi của người bán',
    specs: {
      ...
      storage_capacity: 'Bộ nhớ trong',
      rear_camera: 'Camera sau',
      front_camera: 'Camera trước',
      battery_capacity: 'Pin',
      battery_life: 'Thời gian sử dụng',
      sim_slot: 'Thẻ SIM',
      nfc: 'Công nghệ NFC',
      os: 'Hệ điều hành',
      connectivity_ports: 'Cổng kết nối',
  ...
  voucher: {
    ...
    empty: 'Bạn chưa có mã giảm giá nào',
    useNow: 'Dùng ngay',
    notApplicable: 'Không được áp dụng',
    daysLeft: 'Còn {{days}} ngày',
    hoursLeft: 'Còn {{hours}} tiếng',
  ...
  checkout: {
    ...
    products: 'Sản phẩm',
    shipping: 'Vận chuyển',
    securityNote: 'Toàn bộ các giao dịch được bảo mật và mã hoá',
  ...
  bankTransfer: {
    ...
    saveImage: 'Lưu ảnh về máy',
    paymentImage: 'Ảnh thanh toán',
    paymentProof: 'Minh chứng thanh toán',
  ...
  timeSlot: {
    ...
    allSlots: 'Tất cả khung giờ',
    allSlotsDesc: 'Giao hàng trong khung giờ phù hợp',
    morning: 'Sáng',
    note: 'Khung giờ giao hàng có thể thay đổi tùy thuộc vào khu vực và tình trạng đơn hàng.',
  },
  order: {
